...
namespace Infrastructure.EF.GraphQL
{
    public class Mutation
    {
        ...
        // ------------------- Comment ---------------------
        [Authorize]
        public async Task<CommentDTO> CreateComment([Service] ICommentService commentService, CreateCommentDTO comment)
        {
            return await commentService.CreateCommentToPost(comment);
        }
    }
}